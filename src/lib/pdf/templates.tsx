      ...
      <Page size={pageSize} style={styles.page}>
        ...
        <View style={styles.footer} fixed>
            ...
            {/* Right column — page number + generated-by line.
                NOTE: @react-pdf/renderer v4 does not support the `render`
                prop on Views nested inside a `fixed` parent — it only works
                on direct children of <Page>. Since our footer is a fixed
                View (required for memorandum), the render prop won't fire.
                We render a static "Page 1" as a fallback. When @react-pdf
                fixes this, switch to: render={({pageNumber}) => <Text>Page {pageNumber}</Text>} */}
