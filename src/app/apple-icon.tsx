 ...
 * iOS home-screen icon is byte-for-byte identical to the portal logo,
 * favicon, and browser icon — no more "phone looks different from
 * portal" mismatch.
 *
 ...
 * gradient tile, with a top sheen + bottom shadow for the premium iOS
 * home-screen look. ViewBox is preserved at "0 0 560 600" to maintain
 * the exact aspect ratio of the Wikipedia original.
 */
  ...
  return new ImageResponse(
    (
      ...
      >
        ...
        />
        {/* Bottom shadow for premium depth */}
        <div
          style={{
            position: "absolute",
            bottom: 0,
        ...
        {/*
          ...
          identically to /logo.svg (portal), /favicon.svg (browser),
          and /icon (32x32 PNG).
        */}
        <svg
          width="60%"
