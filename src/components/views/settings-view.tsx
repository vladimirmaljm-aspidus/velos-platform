...
// ── Memorandum (audit33) ─────────────────────────────────────────────────────
// The full Memorandum Studio now lives here AND in Documents → Document
// templates → Memorandum (the same self-fetching component, two mount
// points). The legacy hand-rolled form + HTML approximation preview were
// replaced by the studio: real live paper preview, real PDF preview, and
// settings that ACTUALLY drive every generated document (header name +
// logo, footer address + QR + page number, page setup, margins).
function MemorandumTab() {
  return <MemorandumStudio />;
}
